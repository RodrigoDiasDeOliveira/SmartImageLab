...
class ImageLogger:
    ...
    def log_upload(self, n, s="Sucesso"):     self.log_operation("Upload", n, s)
    def log_download(self, n, s="Sucesso"):   self.log_operation("Download", n, s)
    def log_processing(self, n, s="Sucesso"): self.log_operation("Processamento", n, s)
